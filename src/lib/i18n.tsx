...
export const translations: Translations = {
  ...
  planProFeatureCustomSignalUpdate: { zh: 'KOL自定义信号更新', en: 'KOL custom signal updates' },
  planProFeatureOneClickCopySignal: { zh: 'KOL一键跟单信号', en: 'KOL one-click copy-trade signals' },
