...
export const translations: Translations = {
  ...
  accountValue: { zh: '总收益', en: 'TOTAL PROFIT' },
  ...
  note: { zh: '注意', en: 'Note' },
  leaderboardNote: { zh: '所有统计数据（除总收益和盈亏外）仅反映已完成交易。活跃仓位在关闭前不计入计算。', en: 'All statistics (except total profit and P&L) only reflect completed trades. Active positions are not included until closed.' },
