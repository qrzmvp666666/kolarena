...
export const translations: Translations = {
  ...
  filterDirection: { zh: '交易方向', en: 'Direction' },
  filterTime: { zh: '信号时间', en: 'Time' },
  filterEntryStatus: { zh: '入场状态', en: 'Entry Status' },
  entryPending: { zh: '待入场', en: 'Pending Entry' },
  entryEntered: { zh: '已入场', en: 'Entered' },
  hours: { zh: '小时内', en: 'h' },
  days: { zh: '天内', en: 'd' },
  ...
  chartSelectKol: { zh: '选择 KOL', en: 'Select KOL' },
  chartSelectAll: { zh: '全选', en: 'Select All' },
  chartClear: { zh: '清空', en: 'Clear' },
  chartKolFilter: { zh: 'KOL 筛选', en: 'KOL Filter' },
  chartKeepOne: { zh: '仅保留一个', en: 'Keep One' },
  chartNoPairs: { zh: '暂无交易对', en: 'No trading pairs' },
  chartNoKolSignals: { zh: '暂无 KOL 信号', en: 'No KOL signals' },
  chartAddWindow: { zh: '新增窗口', en: 'Add Window' },
  chartResetLayout: { zh: '重置布局', en: 'Reset Layout' },
  chartLayoutSingle: { zh: '单窗', en: 'Single' },
  chartLayout1x2: { zh: '一行两列', en: '1x2' },
  chartLayout2x1: { zh: '两行一列', en: '2x1' },
  chartLayout2x2: { zh: '两行两列', en: '2x2' },
  chartCloseWindow: { zh: '关闭窗口', en: 'Close Window' },
  chartExpandSidebar: { zh: '展开侧边栏', en: 'Expand Sidebar' },
  chartExpand: { zh: '展开', en: 'Expand' },
  chartCommentsShort: { zh: '评论', en: 'Comments' },
  chartActiveSignalsShort: { zh: '有效信号', en: 'Active Signals' },
  chartHistorySignalsShort: { zh: '历史信号', en: 'History Signals' },
  chartCollapseSidebar: { zh: '收起侧边栏', en: 'Collapse Sidebar' },
  chartCollapse: { zh: '收起', en: 'Collapse' },
  ...
  planPro: { zh: 'Pro', en: 'Pro' },
  planMax: { zh: 'Max会员', en: 'Max' },
  planPriceFree: { zh: '免费', en: 'Free' },
  ...
  billingMonthly: { zh: '月付', en: 'Monthly' },
  billingYearly: { zh: '年付', en: 'Yearly' },
  perMonth: { zh: '/月', en: '/month' },
  perQuarter: { zh: '/季度', en: '/quarter' },
  perYear: { zh: '/年', en: '/year' },
  freePlanActive: { zh: '免费使用中', en: 'Free Plan' },
  ...
  paymentFailed: { zh: '支付失败', en: 'Payment failed' },
  paymentFailedReasonLabel: { zh: '失败原因', en: 'Reason' },
  paymentNetworkOrCorsError: { zh: '网络或跨域配置异常（请求未到达支付服务）', en: 'Network or CORS misconfiguration (request did not reach payment service)' },
  paymentAuthExpired: { zh: '登录状态已失效，请重新登录后重试', en: 'Session expired. Please sign in again and retry' },
  paymentProviderKeyMissing: { zh: '支付服务密钥未配置，请联系管理员', en: 'Payment provider key is missing. Please contact admin' },
  paymentAmountTooSmall: { zh: '当前套餐金额低于该支付币种网络的最小支付金额，请选择更高金额套餐或更换币种', en: 'The current plan amount is below the minimum payment amount for this crypto network. Please choose a higher-priced plan or another currency' },
  paymentContactSupportHint: { zh: '请联系专属客服协助处理。', en: 'Please contact dedicated support for assistance.' },
  purchaseStatusRefreshing: { zh: '刷新状态中...', en: 'Refreshing status...' },
  purchaseStatusRefreshSuccess: { zh: '支付状态已刷新', en: 'Payment status refreshed' },
  purchaseStatusRefreshSuccessDesc: { zh: '已同步 {count} 条购买记录的最新状态', en: 'Updated the latest status for {count} purchase records' },
  ...
  subscriptionDescMonthly: { zh: '不用看了，全网币圈KOL信聚合信号，多维收益排行榜都在这里', en: 'Three core features: live tracking, multi-dimensional rankings, and AI + manual signal verification (Monthly)' },
  subscriptionDescYearly: { zh: '不用看了，全网币圈KOL信聚合信号，多维收益排行榜都在这里', en: 'Three core features: live tracking, multi-dimensional rankings, and AI + manual signal verification (Yearly)' },
  planFreeSectionBasic: { zh: '基础权益', en: 'Basic benefits' },
  planFreeSectionCompared: { zh: '与Pro差异', en: 'Compared with Pro' },
  planFreeFeatureAds: { zh: '含广告展示', en: 'Includes ads' },
  planFreeFeatureDelayedChart: { zh: '聚合K线延迟', en: 'Delayed aggregated charts' },
  planFreeFeatureLimitedSignals: { zh: '信号列表有限且延迟', en: 'Limited and delayed signal list' },
  planFreeFeatureNoRealtimeSignalPush: { zh: '不含KOL实时信号推送', en: 'No KOL real-time signal push' },
  planFreeFeatureNoHistoryRank: { zh: '不含KOL历史收益排行', en: 'No KOL historical profit ranking' },
  planFreeFeatureNoTrendCompare: { zh: '不含KOL多维趋势对比', en: 'No KOL multi-dimensional trend comparison' },
  planFreeFeatureNoLiveBacktest: { zh: '不含KOL实时策略回测', en: 'No KOL real-time strategy backtesting' },
  planFreeFeatureNoDedicatedSupport: { zh: '不含专属客服支持', en: 'No dedicated support' },
  planProFeatureNoAds: { zh: '无广告体验', en: 'Ad-free experience' },
  planProSectionExclusive: { zh: '会员专属', en: 'Exclusive' },
  planProSectionFuture: { zh: '未来权益', en: 'Future benefits' },
  planProSectionMore: { zh: '更多权益', en: 'More benefits' },
  planProFeatureMarketQuotes: { zh: '币圈实时市场报价', en: 'Real-time market quotes' },
  planProFeatureChartTracking: { zh: 'KOL聚合K线跟踪', en: 'KOL aggregated chart tracking' },
  planProFeatureSignalPush: { zh: 'KOL实时信号推送', en: 'KOL real-time signal push' },
  planProFeatureSignalAlert: { zh: 'KOL信号跟踪提醒', en: 'KOL signal tracking alerts' },
  planProFeatureCustomSignalUpdate: { zh: 'KOL自定义信号通知', en: 'KOL custom signal notifications' },
  planProFeatureOneClickCopySignal: { zh: 'KOL信号一键跟单', en: 'KOL signal one-click copy trading' },
  planProFeatureHistoryRank: { zh: 'KOL历史收益排行', en: 'KOL historical rankings' },
  planProFeatureHistoryAnalysis: { zh: 'KOL历史数据分析', en: 'KOL historical data analysis' },
  planProFeatureTrendCompare: { zh: 'KOL多维趋势对比', en: 'KOL multi-dimensional trend comparison' },
  planProFeatureLiveBacktest: { zh: 'KOL实时策略回测', en: 'KOL real-time strategy backtesting' },
  planProFeatureSupport: { zh: '专属客服支持', en: 'Dedicated support' },
  planProFeatureCommunityNotice: { zh: '专属社区通知', en: 'Exclusive community notifications' },
  ...
  paymentOrderId: { zh: '订单号', en: 'Order ID' },
  internalOrderId: { zh: '内部单号', en: 'Internal Order ID' },
  paymentProviderId: { zh: '支付单号', en: 'Payment ID' },
  collapseDetails: { zh: '收起详细信息', en: 'Collapse Details' },
  expandDetails: { zh: '展开详细信息', en: 'Expand Details' },
  paymentStatusLabel: { zh: '支付状态', en: 'Status' },
  paymentStatus_waiting: { zh: '等待支付', en: 'Waiting for payment' },
  paymentStatus_pending: { zh: '待确认', en: 'Pending' },
  paymentStatus_confirming: { zh: '链上确认中', en: 'Confirming on-chain' },
  paymentStatus_paid: { zh: '已支付', en: 'Paid' },
  paymentStatus_finished: { zh: '已完成', en: 'Finished' },
  paymentStatus_sending: { zh: '转账处理中', en: 'Sending' },
  paymentStatus_confirmed: { zh: '已确认', en: 'Confirmed' },
  paymentStatus_failed: { zh: '支付失败', en: 'Failed' },
  paymentStatus_expired: { zh: '已过期', en: 'Expired' },
  paymentStatus_refunded: { zh: '已退款', en: 'Refunded' },
  paymentStatus_partially_paid: { zh: '部分到账', en: 'Partially paid' },
  paymentAddress: { zh: '支付地址', en: 'Payment Address' },
  paymentQrCodeHint: { zh: '请使用钱包扫描二维码进行转账', en: 'Scan this QR code with your wallet to pay' },
  copyPaymentAddress: { zh: '复制支付地址', en: 'Copy Payment Address' },
  paymentAddressCopied: { zh: '支付地址已复制', en: 'Payment address copied' },
  paymentManualTransferHint: { zh: '请在钱包中按金额向该地址转账，到账后会员权益将自动开通。', en: 'Transfer the exact amount to this address from your wallet. Membership activates automatically after confirmation.' },
  hasPaidPrompt: { zh: '若已支付，可前往购买记录查看最新状态。', en: 'If already paid, you can check the latest status in Purchase Records.' },
  viewPurchaseRecords: { zh: '查看购买记录', en: 'View Purchase Records' },
  ...
  // Backtest
  strategyBacktest: { zh: '策略回测', en: 'Strategy Backtest' },
  backtestTitle: { zh: '策略回测', en: 'Strategy Backtest' },
  backtestSubtitle: { zh: '基于 KOL 历史信号，模拟不同投入策略的收益表现', en: 'Simulate returns based on KOL historical signals with different investment strategies' },
  initialCapital: { zh: '账户本金', en: 'Initial Capital' },
  initialCapitalPlaceholder: { zh: '请输入初始资金', en: 'Enter initial capital' },
  investMode: { zh: '回测模式', en: 'Invest Mode' },
  fixedInvest: { zh: '固定投入', en: 'Fixed Investment' },
  compoundInvest: { zh: '复利投入', en: 'Compound Investment' },
  fixedInvestDesc: { zh: '每笔交易投入固定的金额或当前余额的固定百分比', en: 'Invest a fixed amount or percentage of current balance per trade' },
  compoundInvestDesc: { zh: '每笔交易以上一笔信号的期末资金作为本次投入，实现资金滚动增长', en: 'Each trade uses the ending balance from the previous signal as the investment, enabling compounding growth' },
  investType: { zh: '投入方式', en: 'Investment Type' },
  byAmount: { zh: '按金额', en: 'By Amount' },
  byPercent: { zh: '按百分比', en: 'By Percentage' },
  investAmount: { zh: '每次投入金额', en: 'Investment Amount' },
  investAmountPlaceholder: { zh: '如: 1000', en: 'e.g. 1000' },
  investPercent: { zh: '每次投入百分比', en: 'Investment Percentage' },
  investPercentPlaceholder: { zh: '如: 10', en: 'e.g. 10' },
  investAmountHint: { zh: '每笔交易固定投入 {value} USDT', en: 'Fixed investment of {value} USDT per trade' },
  investPercentHint: { zh: '每笔交易投入当前账户余额的 {value}%', en: 'Invest {value}% of current balance per trade' },
  leverageSetting: { zh: '杠杆设置', en: 'Leverage Setting' },
  useSignalLeverage: { zh: '使用信号原始杠杆', en: 'Use Signal Leverage' },
  useCustomLeverage: { zh: '自定义统一杠杆', en: 'Custom Unified Leverage' },
  customLeverage: { zh: '统一杠杆倍数', en: 'Unified Leverage' },
  customLeveragePlaceholder: { zh: '如: 10', en: 'e.g. 10' },
  runBacktest: { zh: '开始回测', en: 'Run Backtest' },
  backtestRunning: { zh: '回测计算中...', en: 'Running backtest...' },
  backtestResult: { zh: '回测结果', en: 'Backtest Results' },
  equityCurve: { zh: '资金曲线', en: 'Equity Curve' },
  summaryMetrics: { zh: '汇总指标', en: 'Summary Metrics' },
  tradeDetail: { zh: '交易明细', en: 'Trade Details' },
  monthlyStats: { zh: '月度统计', en: 'Monthly Stats' },
  finalCapital: { zh: '期末资金', en: 'Final Capital' },
  totalReturnRate: { zh: '总收益率', en: 'Total Return' },
  totalPnLAmount: { zh: '总盈亏', en: 'Total P&L' },
  maxDrawdown: { zh: '最大回撤', en: 'Max Drawdown' },
  profitFactorLabel: { zh: '盈亏因子', en: 'Profit Factor' },
  avgReturnPerTrade: { zh: '平均每笔收益', en: 'Avg Return/Trade' },
  totalTradesCount: { zh: '总交易笔数', en: 'Total Trades' },
  winCount: { zh: '盈利笔数', en: 'Win Count' },
  lossCount: { zh: '亏损笔数', en: 'Loss Count' },
  maxSingleProfit: { zh: '单笔最大盈利', en: 'Max Single Profit' },
  maxSingleLoss: { zh: '单笔最大亏损', en: 'Max Single Loss' },
  backtestBalanceBefore: { zh: '期初资金', en: 'Balance Before' },
  backtestBalanceAfter: { zh: '期末资金', en: 'Balance After' },
  backtestInvestAmount: { zh: '投入金额', en: 'Invested' },
  backtestPnlAmount: { zh: '盈亏金额', en: 'P&L Amount' },
  backtestMonth: { zh: '月份', en: 'Month' },
  backtestMonthPnl: { zh: '月盈亏', en: 'Monthly P&L' },
  backtestMonthReturn: { zh: '月收益率', en: 'Monthly Return' },
  backtestMonthTrades: { zh: '交易笔数', en: 'Trades' },
  backtestMonthWinRate: { zh: '月胜率', en: 'Win Rate' },
  backtestNoData: { zh: '该 KOL 在选定时间范围内没有已平仓的信号数据', en: 'No closed signals found for this KOL in the selected time range' },
  backtestError: { zh: '回测失败，请稍后重试', en: 'Backtest failed, please try again later' },
  backToDataOverview: { zh: '返回数据概览', en: 'Back to Overview' },
  backtestParamSection: { zh: '回测参数设置', en: 'Backtest Parameters' },
  accountBalance: { zh: '账户余额', en: 'Account Balance' },
  cumulativeReturn: { zh: '累计收益率', en: 'Cumulative Return' },
  ...
  planFreeDesc: { zh: '基础功能可用，适合先体验平台', en: 'Basic features for getting started' },
  planProDesc: { zh: '解锁进阶交易工具与更完整权益', en: 'Unlock advanced tools and full features' },
  planLifetimeDesc: { zh: '一次购买，永久享受高级会员权益', en: 'One-time purchase, lifetime premium access' },
