...
export const translations: Translations = {
  ...
  subscriptionDescMonthly: { zh: '聚焦三大特色：千人实盘追踪、多维收益排行榜、AI+人工双重信号验证（当前月付）', en: 'Three core features: live tracking, multi-dimensional rankings, and AI + manual signal verification (Monthly)' },
  subscriptionDescYearly: { zh: '聚焦三大特色：千人实盘追踪、多维收益排行榜、AI+人工双重信号验证（当前年付）', en: 'Three core features: live tracking, multi-dimensional rankings, and AI + manual signal verification (Yearly)' },
  ...
  planProFeatureHistoryRank: { zh: 'KOL历史排行榜', en: 'KOL historical rankings' },
  planProFeatureHistoryAnalysis: { zh: 'KOL历史数据分析', en: 'KOL historical data analysis' },
  planProFeatureTrendCompare: { zh: 'KOL多维度趋势对比', en: 'KOL multi-dimensional trend comparison' },
