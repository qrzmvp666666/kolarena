    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[400px] p-0 overflow-hidden">
        ...
        <div className="px-6 pb-8">
          <Tabs value={loginMode} onValueChange={(v) => setLoginMode(v as 'otp' | 'password')} className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-6">
              <TabsTrigger value="otp" className="font-mono text-xs gap-1">
                <Mail className="w-3 h-3" />
                {t('otpLogin')}
              </TabsTrigger>
              <TabsTrigger value="password" className="font-mono text-xs gap-1">
          ...
          >
            <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
              ...
              />
              <path
                d="M12 5.38c1.62 0 3.06.56 4.21 1.66l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 6.23l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
                fill="#EA4335"
              />
            </svg>
            {t('googleLogin')}
          ...
          <p className="text-center text-[10px] text-muted-foreground mt-8 font-mono opacity-50">
            {t('register')}
          </p>
        </div>
      </DialogContent>
